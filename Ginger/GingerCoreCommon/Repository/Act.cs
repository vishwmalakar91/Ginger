...
namespace GingerCore.Actions
{
    ...
    public abstract partial class Act : RepositoryItemBase
    {
        ...
        private Amdocs.Ginger.Common.Enums.eRunStatus? mStatus;
        public Amdocs.Ginger.Common.Enums.eRunStatus? Status { get { return mStatus; } set { mStatus = value; OnPropertyChanged(Fields.Status); } }
        ...
        public bool? CheckIfVaribalesDependenciesAllowsToRun(Activity parentActivity, bool setActStatus = false)
        {
            ...
            try
            {
                ...
                {
                    this.Status = Amdocs.Ginger.Common.Enums.eRunStatus.Skipped;
        ...
        public void Reset()
        {
            if (this != null)
            {
                ...
                this.Status = Amdocs.Ginger.Common.Enums.eRunStatus.Pending;
            }
        }    // end of Reset
