...
namespace GingerCore.FlowControlLib
{
    ...
    {        
        ...
        public void CalculateCondition(BusinessFlow BusinessFlow, Environments.ProjEnvironment ProjEnvironment, Act act, ObservableList<DataSourceBase> DSList)
        {
            ...
            VE.Value = VE.Value.Replace("{ActionStatus}", (act.Status == Amdocs.Ginger.Common.Enums.eRunStatus.FailIgnored ? Amdocs.Ginger.Common.Enums.eRunStatus.Failed : act.Status).ToString());
        ...
        public void CalculateCondition(BusinessFlow BusinessFlow, Environments.ProjEnvironment ProjEnvironment, ObservableList<DataSourceBase> DSList)
        {
            ...
            VE.Value = VE.Value.Replace("{BusinessFlowStatus}", (BusinessFlow.RunStatus == Amdocs.Ginger.Common.Enums.eRunStatus.Failed ? Amdocs.Ginger.Common.Enums.eRunStatus.Failed : BusinessFlow.RunStatus).ToString());
